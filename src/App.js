    ...
    return (
      <div className="App">
          ...
          <nav>
            <div className="row">
              ...
              <div className="progression">
                ...
                <span className="hour">d&eacute;but : 20h30 &mdash; fin : <span className="end js--end">23h00</span> (lvl: <span className="js--lvl">0</span>)</span>
              </div>
          ...
          <div className="one-minute-box">
            ...
            <div className="parameters">
              <form action="" id="parameters-form">
                <input type="number" placeholder="Durée (H)" className="total-duration js--total-duration" min="1" max="4.5" step="0.5" required />
                <a href="#game" className="material-btn js--submit">c'est parti !</a>
              </form>
            </div>
          </div>
        </header>
        <section className="section-game js--section-game" id="game">
          <div className="clock">
              <div className="time js--time-left">--:--</div>
              <div className="control">
                  {/* PREVIOUS button */}
                  <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid" className="game-button js--previous" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6 6h2v12H6zm3.5 6l8.5 6V6z"></path>
                  </svg>
                  <div className="play js--play">
                    {/* PLAY button */}
                    <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid" className="game-button play-button js--play-button" xmlns="http://www.w3.org/2000/svg">
                      <g><path d="M8 5v14l11-7z"></path></g>
                    </svg>

                    {/* PAUSE button */}
                    <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid" className="game-button pause-button js--pause-button" xmlns="http://www.w3.org/2000/svg">
                      <path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z"></path>
                    </svg>
                  </div>
                  {/* NEXT button */}
                  <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid" className="game-button js--next" xmlns="http://www.w3.org/2000/svg">
